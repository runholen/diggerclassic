...
boolean hasStarted = false; //Added by rho
...
//	  recputinit();
  ...
  } while (running); //dig.Input.escape);
/*  dig.Sound.soundoff();
  restoreint8();
  restorekeyb();
  graphicsoff(); */
...
void testpause () {
	//System.out.println(dig.Input.akeypressed);
